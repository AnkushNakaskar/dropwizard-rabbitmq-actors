...
import io.test.opentracing.util.TracerUtil;
...
import static io.test.opentracing.TracingConstants.VALID_PARAM_VALUE_PATTERN;
...
public class TracingAspect {
    ...
    @Pointcut("@annotation(io.test.opentracing.TracingAnnotation)")
